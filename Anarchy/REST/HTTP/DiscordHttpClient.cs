                ...
                try
                {
                    ...
                    if (_discordClient.Proxy == null || _discordClient.Proxy.Type == ProxyType.HTTP)
                    {
                        ...
                        if (_discordClient.User != null && _discordClient.User.Type == DiscordUserType.Bot)
                            client.DefaultRequestHeaders.Add("User-Agent", "Anarchy/0.8.2.1");
                        else
                        {
                    ...
                    else
                    {
                        HttpRequest msg = new()
                        {
                            ...
                            UserAgent = _discordClient.User != null && _discordClient.User.Type == DiscordUserType.Bot ? "Anarchy/0.8.2.1" : _discordClient.Config.SuperProperties.UserAgent,
